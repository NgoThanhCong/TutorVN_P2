...
const navigation = [
  ...
  { name: 'Tutor', href: '#', current: false },
  { name: 'Parents', href: '#', current: false },
  { name: 'Commitment to quality', href: '#', current: false },
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'border-red-300 text-red-300' : 'border-transparent text-gray-200',
